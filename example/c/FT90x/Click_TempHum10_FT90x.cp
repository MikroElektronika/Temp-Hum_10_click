#line 1 "D:/Clicks_git/T/Temp-Hum_10_click/SW/example/c/FT90x/Click_TempHum10_FT90x.c"
#line 1 "d:/clicks_git/t/temp-hum_10_click/sw/example/c/ft90x/click_temphum10_types.h"
...
#line 1 "d:/clicks_git/t/temp-hum_10_click/sw/example/c/ft90x/click_temphum10_config.h"
#line 1 "d:/clicks_git/t/temp-hum_10_click/sw/example/c/ft90x/click_temphum10_types.h"
#line 16 "d:/clicks_git/t/temp-hum_10_click/sw/example/c/ft90x/click_temphum10_config.h"
const uint32_t _TEMPHUM10_I2C_CFG[ 2 ] =
{
...
float temphum10_getTemperature(uint8_t tempIn);

void temphum10_setDeviceMode(uint8_t mode);

uint16_t temphum10_getCapacity();

void temphum10_repeatMeasurement(uint8_t average);
#line 31 "D:/Clicks_git/T/Temp-Hum_10_click/SW/example/c/FT90x/Click_TempHum10_FT90x.c"
float Temperature = 0;
float Humidity = 0;
char demoText[ 20 ];
...
{
 temphum10_repeatMeasurement(_TEMPHUM10_AM_NO_AVERAGING_PROCESS);

 Temperature = temphum10_getTemperature(1);
